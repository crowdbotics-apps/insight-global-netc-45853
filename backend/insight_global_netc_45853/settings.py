"""
Django settings for insight_global_netc_45853 project.
...
ROOT_URLCONF = 'insight_global_netc_45853.urls'
...
WSGI_APPLICATION = 'insight_global_netc_45853.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "insight_global_netc_45853 API",
    "DESCRIPTION": "API documentation for insight_global_netc_45853 App",
    "VERSION": "v1",
}
